...
export function ServicesGrid({detailed = false}: { detailed?: boolean }) {
    return (
        ...
        >
            ...
            <div
                aria-hidden
                className="pointer-events-none absolute left-1/2 top-24 -z-10 h-72 w-[46rem] max-w-full -translate-x-1/2 rounded-full bg-gold-wash/50 blur-3xl"
            />
                ...
                <ScrollGrow className="mt-16 flex flex-wrap justify-center gap-6">
                    {site.services.map((s, i) => {
                        ...
                        return (
                            ...
                            >
                                <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-surface p-8 shadow-[0_4px_16px_rgba(14,42,71,0.05)] transition duration-300 ease-out hover:-translate-y-1.5 hover:border-gold/40 hover:shadow-[0_24px_48px_-20px_rgba(14,42,71,0.28)]">
                                    ...
                                    <span className="inline-flex size-14 items-center justify-center rounded-2xl bg-ink text-surface shadow-sm transition duration-300 group-hover:-translate-y-0.5 group-hover:bg-gold group-hover:text-ink">
                                        <Icon className="size-7" strokeWidth={1.75} aria-hidden />
                                    </span>
                                    <h3 className="mt-6 font-display text-xl font-semibold text-ink transition-colors duration-300 group-hover:text-navy md:text-2xl">
                                        {s.title}
                                    </h3>
